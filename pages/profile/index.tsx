      ...
      <div className="py-10 px-4">
        ...
        <div className="my-8 flex justify-around">
          <Link href="/profile/sold">
            <div className="flex justify-center items-center flex-col space-y-1 cursor-pointer group">
              <div className="w-12 h-12 bg-fuchsia-700 rounded-full flex items-center justify-center group-hover:bg-fuchsia-800 group-active:bg-fuchsia-900">
                <svg
                  className="w-6 h-6"
                  fill="none"
                  stroke="#fff"
              ...
              <span className="font-light text-gray-600 text-xs group-hover:text-gray-700 group-active:text-gray-900">
                판매내역
              </span>
            </div>
          </Link>
